...
/* productor-consumidor con semaforos y mutex*/
...
#define MAX_BUFFER          15	// Buffer
#define DATOS_A_PRODUCIR    15  // DATOS A PRODUCIR POR CADA PRODUCTOR
